// Code generated by gentypes.go; DO NOT EDIT.
...
func (a *BtfGetFdByIdAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_BTF_GET_FD_BY_ID, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *BtfLoadAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_BTF_LOAD, unsafe.Pointer(a), unsafe.Sizeof(*a)
}

type EnableStatsAttr struct{ Type uint32 }

func (a *EnableStatsAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_ENABLE_STATS, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *IterCreateAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_ITER_CREATE, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *LinkCreateAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_LINK_CREATE, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *LinkCreateIterAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_LINK_CREATE, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *LinkUpdateAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_LINK_UPDATE, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *MapCreateAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_CREATE, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *MapDeleteBatchAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_DELETE_BATCH, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *MapDeleteElemAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_DELETE_ELEM, unsafe.Pointer(a), unsafe.Sizeof(*a)
}

type MapFreezeAttr struct{ MapFd uint32 }

func (a *MapFreezeAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_FREEZE, unsafe.Pointer(a), unsafe.Sizeof(*a)
}

type MapGetFdByIdAttr struct{ Id uint32 }

func (a *MapGetFdByIdAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_GET_FD_BY_ID, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *MapGetNextIdAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_GET_NEXT_ID, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *MapGetNextKeyAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_GET_NEXT_KEY, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *MapLookupAndDeleteBatchAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_LOOKUP_AND_DELETE_BATCH, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *MapLookupAndDeleteElemAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_LOOKUP_AND_DELETE_ELEM, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *MapLookupBatchAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_LOOKUP_BATCH, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *MapLookupElemAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_LOOKUP_ELEM, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *MapUpdateBatchAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_UPDATE_BATCH, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *MapUpdateElemAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_MAP_UPDATE_ELEM, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *ObjGetAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_OBJ_GET, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *ObjGetInfoByFdAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_OBJ_GET_INFO_BY_FD, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *ObjPinAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_OBJ_PIN, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *ProgAttachAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_PROG_ATTACH, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *ProgDetachAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_PROG_DETACH, unsafe.Pointer(a), unsafe.Sizeof(*a)
}

type ProgGetFdByIdAttr struct{ Id uint32 }

func (a *ProgGetFdByIdAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_PROG_GET_FD_BY_ID, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *ProgGetNextIdAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_PROG_GET_NEXT_ID, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *ProgLoadAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_PROG_LOAD, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *ProgRunAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_PROG_TEST_RUN, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
...
func (a *RawTracepointOpenAttr) cmd() (Cmd, unsafe.Pointer, uintptr) {
	return BPF_RAW_TRACEPOINT_OPEN, unsafe.Pointer(a), unsafe.Sizeof(*a)
}
